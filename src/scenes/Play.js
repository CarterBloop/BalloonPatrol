class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // blue UI background
        this.add.rectangle(0, borderUISize + borderPadding, game.config.width, borderUISize * 2, 0xC0F3F5).setOrigin(0, 0);
        // white borders
        ...
        this.ship04 = new SpaceshipSmall(this, game.config.width, borderUISize * 3 + borderUISize, 'spaceshipSmall', 0, 50).setOrigin(0, 0);
        // define keys
